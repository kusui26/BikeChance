...
| ⭐ 9/21（月・祝） | 08:30 JST 以降に当てはめ直して昇格 | `fit_baseline`（09-14〜09-20）→ 評価 → 登録 → `promote_model_version` |
| 9/22（火・休） | 予備 | 遅れを吸う |
