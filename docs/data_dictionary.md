...
- **本番稼働中（2026-09-08 20:24 JST から、HELLO のみ）。** 14,635 行・7.2 MB（**2026-09-09 07:29 の実測**、運転 11 時間 5 分・134 サイクル）。ドコモはまだ入れていない
